...
class Player {
    ...
    float radius = 0.5f, acceleration = 0.015f, decceleration = 0.005f, maxVelocity = 0.14f, gravity = 0.01f, maxFallSpeed = 0.4f, jumpPower = 0.25f, wallJumpHorPower = 0.22f, wallSlideVelocity = 0.07f, jumpReleasePower = 0.045f, airDriftMult = 0.2f;
